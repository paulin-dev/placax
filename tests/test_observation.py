...
def test_make_wiremask_observation_adds_lookahead_wiremasks_without_dropping_the_base() -> None:
    ...
    assert "wiremask" not in obs  # not buffered separately - it's just lookahead_wiremasks[0]
