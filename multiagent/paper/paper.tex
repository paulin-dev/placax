...
\caption{What each method reaches against the time it needs (log scale). The black line is simulated annealing at five budgets, with the band spanning its seeds. Markers are single runs of the other methods at their measured wall clock, including compilation.}
\label{fig:time}
\end{figure}
